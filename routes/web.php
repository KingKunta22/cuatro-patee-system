...
Route::put('purchase-orders/updatePurchaseOrder', [PurchaseOrderController::class, 'updatePurchaseOrder'])->name('purchase-orders.updatePurchaseOrder')->middleware('auth');