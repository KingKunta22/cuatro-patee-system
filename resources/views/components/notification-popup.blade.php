...
<div x-data="{
    ...
    init() {
        ...
        this.$nextTick(() => {
            ...
            }, 2000); // Show first popup 2 seconds after page load
        });
    },
...
class="fixed bottom-4 right-4 w-80 z-50">
    <div x-show="showPopup && currentPopup" class="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
        <!-- Header -->
