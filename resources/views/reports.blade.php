<x-layout>
    ...
    <div x-data="{ activeTab: '{{ request('tab', 'product') }}' }" 
        ...
        <div class="w-full flex items-center justify-between bg-white rounded-lg pb-2 pt-4">
            ...
            <button @click="printCurrentReport(activeTab)" 
                    class="flex items-center space-x-1 cursor-pointer bg-blue-500 text-white hover:bg-blue-600 px-3 py-2 rounded transition-colors">
